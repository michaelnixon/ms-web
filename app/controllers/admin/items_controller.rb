class Admin::ItemsController < ApplicationController
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:name, :body, :preview, :bootsy_image_gallery_id, :image, :category_id, :promoted, :remove_image, attachments_attributes: [:description, :file, :_destroy, :id])
    end
end
